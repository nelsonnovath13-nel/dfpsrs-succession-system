...
const DICT: Record<string, { en: string; sw: string }> = {
  ...
  vault: { en: "Family Legacy Vault", sw: "Hazina ya Urithi wa Familia" },
  vault_access: { en: "Vault Access (Trustee)", sw: "Ufikiaji wa Hazina (Mwaminifu)" },
  ...
  handbook: { en: "User Handbook", sw: "Kitabu cha Mtumiaji" },
  ...
  status_report_generated: { en: "Report Generated", sw: "Ripoti Imetengenezwa" },
  ...
  status_pending_review: { en: "Pending Review", sw: "Inasubiri Ukaguzi" },
  status_suspended: { en: "Suspended", sw: "Imesimamishwa" },
  status_expired: { en: "Expired", sw: "Imepitwa na Muda" },
  verifiers: { en: "Official Verifiers", sw: "Wathibitishaji Rasmi" },
  become_verifier: { en: "Become a Verifier", sw: "Kuwa Mthibitishaji" },
