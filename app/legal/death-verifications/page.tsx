...
export default function LegalDeathVerificationsPage() {
    ...
    <DashboardShell role="legal">
      ...
      {loading ? (
        ...
        <div className="space-y-3 mb-8">
          {pending.map((r) => (
            <Link key={r.id} href={`/legal/death-verifications/${r.id}`} className="card flex items-center justify-between hover:bg-neutralLight transition">
